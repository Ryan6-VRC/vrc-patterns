...
The failure mode that buys is the one this entry is built around: a rig that never wakes leaves its walk waiting and the wire holds the last committed pose. Nothing publishes a position it did not measure.
