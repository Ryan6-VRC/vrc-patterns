...
| [`box-tracker`](box-tracker/) | Same, reconstructed to an exact absolute position on a smaller contact budget — generally supersedes contact-tracker | 4-receiver linear reconstruction + crawler servo | Module |
