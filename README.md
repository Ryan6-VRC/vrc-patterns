...
| Same, at 4 receivers instead of 6 — exact absolute readout (linear 4-box reconstruction), unlimited travel (crawler), low contact budget | Module | [`contact-tracker-box`](contact-tracker-box/) |
