...
| [`selective-animation`](selective-animation/) | Point at someone and hold: their copy of you changes and nobody else's does, and it stays until you clear it — plus a menu bool that tags your own copy | per-client raycast masked to the observer's own capsule + an animator-local state latch; 3 synced bits however many are tagged | Module |
