...
| Same, reconstructed to an exact absolute position, on a smaller contact budget | 4-receiver linear reconstruction + crawler servo | Module | [`box-tracker`](box-tracker/) |
